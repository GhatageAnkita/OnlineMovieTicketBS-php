        ...
        <form action="process_search.php" id="reservation-form" method="post" onsubmit="myFunction()">
		       <fieldset>
		       	<div class="field" >
                                ...
                                <input type="text" placeholder="Enter A Movie Name" style="height:34px;width:300px;padding-top:5px;"  required id="search111" name="search">
                                
                                <input type="submit" value="Search" style="height:34px;padding-top:3px;margin-left:5px" id="button111">
    </div>       	
